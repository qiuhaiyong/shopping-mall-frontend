...
export default {
  ...
  computed: {
    ...mapState('trade', { addressInfo: 'address', orderInfo: 'orderInfo' }),
    // 将来提交订单最终选中地址
    userDefalutAddress() {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.userDefalutAddress.consignee, //收件人名字
        consigneeTel: this.userDefalutAddress.phoneNum, //手机号
        deliveryAddress: this.userDefalutAddress.fullAddress, //地址
